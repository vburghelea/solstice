...
- Use `docs/sin-rfp/archive/superseded/5.2-pro-review-output/consolidated-backlog.md` (Stream H - Privacy, DSAR, and retention) as the source of truth.
...
- `docs/sin-rfp/archive/streams/stream-h-context.md`
...
- Added DSAR context summary in `docs/sin-rfp/archive/streams/stream-h-context.md`.
