...
- `docs/sin-rfp/archive/superseded/5.2-pro-review-output/6-implementation.md` (test gaps + E2E coverage)
- `docs/sin-rfp/archive/superseded/5.2-pro-review-output/d0-decision-analysis.md` (scoping decisions)
- `docs/sin-rfp/review-plans/property-based-testing-plan.md` (PBT priorities)
