...
```bash
npx repomix@latest --token-count-tree 50 --include "src/features/organizations/**/*.ts,src/features/organizations/**/*.tsx,src/features/security/**/*.ts,src/features/security/**/*.tsx,src/db/schema/organizations.schema.ts,src/db/schema/security.schema.ts,src/lib/security/**/*.ts,docs/sin-rfp/requirements/tickets/SIN-IMPLEMENTATION-BACKLOG-V2.md,docs/sin-rfp/source/VIASPORT-PROVIDED-system-requirements-addendum.md" -o repomix-sin-bundle4-foundation.xml
```
...
```bash
npx repomix@latest --token-count-tree 50 --include "docs/sin-rfp/requirements/tickets/SIN-IMPLEMENTATION-BACKLOG-V2.md,docs/sin-rfp/worklogs/master.md,docs/sin-rfp/archive/completed/route-tree-implementation-plan.md,docs/sin-rfp/archive/completed/route-tree-implementation-review.md,docs/sin-rfp/requirements/SIN-IMPLEMENTATION-TECHNICAL-DEBT.md,docs/sin-rfp/requirements/SIN-REQUIREMENTS.md,docs/sin-rfp/phase-0/architecture-reference.md,docs/sin-rfp/phase-0/security-controls.md,docs/sin-rfp/phase-0/audit-retention-policy.md,docs/sin-rfp/phase-0/data-residency.md,docs/sin-rfp/phase-0/backup-dr-plan.md" -o repomix-sin-bundle5-docs.xml
```
...
```bash
npx repomix@latest --token-count-tree 50 --include "e2e/tests/authenticated/sin-*.ts,e2e/tests/authenticated/sin-*.spec.ts,src/features/auth/**/*.ts,src/features/auth/**/*.tsx,src/lib/auth/**/*.ts,src/routes/api/auth/**/*.ts,scripts/seed-global-admins.ts,scripts/seed-sin-data.ts,docs/sin-rfp/requirements/tickets/SIN-IMPLEMENTATION-BACKLOG-V2.md,docs/sin-rfp/phase-0/security-controls.md" -o repomix-sin-bundle6-tests-auth.xml
```
