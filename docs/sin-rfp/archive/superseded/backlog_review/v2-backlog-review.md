...
`docs/sin-rfp/requirements/tickets/SIN-IMPLEMENTATION-BACKLOG-V2.md` and how the current code
aligns with `docs/sin-rfp/requirements/SIN-REQUIREMENTS.md`. The focus is on security,
...
- Technical Debt Tracked
  - See `docs/sin-rfp/requirements/SIN-IMPLEMENTATION-TECHNICAL-DEBT.md` for design decisions,
