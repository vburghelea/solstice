# ADR-2025-12-26-d0-10-member-directory-exposure: Member directory exposure
...
Keep full member list admin-only; defer any non-admin directory to a separate redacted endpoint.
