# ADR-2025-12-26-d0-9-org-creation-policy: Organization creation policy
...
Restrict organization creation to global admins only.

## Context

- This decision maps to D0.9 in `docs/sin-rfp/archive/superseded/5.2-pro-review-output/consolidated-backlog.md`.
- See `docs/sin-rfp/archive/superseded/5.2-pro-review-output/d0-decision-analysis.md` for options
  and rationale.

## Options considered

- See the D0.9 section in `docs/sin-rfp/archive/superseded/5.2-pro-review-output/d0-decision-analysis.md`.
