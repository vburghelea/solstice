...
1. Saved report endpoints are not scoped to organization access.
   ...
   - Evidence: `src/features/reports/reports.queries.ts`, `src/features/reports/reports.mutations.ts`, `docs/sin-rfp/worklogs/stream-c.md`.
...
2. SIN organization admin endpoints are missing admin enforcement (privilege escalation).
   ...
   - Status: **Fixed** (Stream C).
   - Evidence: `src/features/organizations/organizations.mutations.ts`, `src/features/organizations/organizations.queries.ts`, `docs/sin-rfp/worklogs/stream-c.md`.
...
3. Privacy admin mutations are missing admin enforcement.
   ...
   - Status: **Fixed** (Stream C).
   - Evidence: `src/features/privacy/privacy.mutations.ts`, `docs/sin-rfp/worklogs/stream-c.md`.
...
4. Reporting queries allow unauthenticated access to sensitive org data.
   ...
   - Status: **Fixed** (Stream C).
   - Evidence: `src/features/reporting/reporting.queries.ts`, `docs/sin-rfp/worklogs/stream-c.md`.
...
1. Active org selection can be bypassed or go stale across sessions.
   ...
   - Evidence: `src/routes/__root.tsx`, `src/features/organizations/org-context.tsx`, `src/features/organizations/org-context-utils.ts`, `docs/sin-rfp/worklogs/stream-b.md`.
...
2. Report export relies on headers/filters that portal UI does not set.
   ...
   - Status: **Fixed** (Stream C).
   - Evidence: `src/features/reports/reports.mutations.ts`, `docs/sin-rfp/worklogs/stream-c.md`.
...
4. Tenant env resolution imports client env in server contexts.
   ...
   - Evidence: `src/lib/env.client.ts`, `docs/sin-rfp/worklogs/stream-b.md`.
...
7. Notification admin mutations lack admin checks, and notification creation is unauthenticated.
   ...
   - Status: **Fixed** (Stream C).
   - Evidence: `src/features/notifications/notifications.mutations.ts`, `docs/sin-rfp/worklogs/stream-c.md`.
