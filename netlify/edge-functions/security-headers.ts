...
export default async function handler(req: Request, context: Context) {
  ...
  const headers = {
    "Content-Security-Policy": [
      ...
      `script-src 'self' 'unsafe-eval' 'strict-dynamic' 'nonce-${nonce}' 'sha256-NatFdn9qa3ivEDVSUujTj3/04jf+6XsuTh7hTdyWQdE=' 'sha256-KlDLetaHs3jydugAFrZVquz1h6i4vHS3ohIh0sfZqC4=' 'sha256-xqOjbNm60mQzEVYVjZCljL+3FDPBOA1akQuoSdPNNtw=' https://challenges.cloudflare.com https://eu-assets.i.posthog.com https://eu.i.posthog.com blob:`,
