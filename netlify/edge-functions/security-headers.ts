...
export default async function handler(req: Request, context: Context) {
  ...
  const headers = {
    "Content-Security-Policy": [
      ...
      `script-src 'self' 'unsafe-eval' 'nonce-${nonce}' 'sha256-NatFdn9qa3ivEDVSUujTj3/04jf+6XsuTh7hTdyWQdE=' 'sha256-KlDLetaHs3jydugAFrZVquz1h6i4vHS3ohIh0sfZqC4=' 'sha256-xqOjbNm60mQzEVYVjZCljL+3FDPBOA1akQuoSdPNNtw=' 'sha256-5JedoFHPMD1o/9fNxPf7aN8DGXTYs9UJC2bTfRPBFxY=' 'sha256-gHUVPg/ygmuHop+u65qJwyip1pg0/k2Ch2Va8wmwlgY=' 'sha256-s54ryQo8y5po8I0tisdtwVfzc5SNbhdkRZtQusfwTaQ=' 'sha256-VIabm1YFAgANPeD6rD6gUm1ZOOTi8FSI2ByX1Bk1Dws=' https://challenges.cloudflare.com https://eu-assets.i.posthog.com https://eu.i.posthog.com blob:`,
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://fonts.gstatic.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: https: blob: https://lh3.googleusercontent.com https://lh4.googleusercontent.com https://lh5.googleusercontent.com https://lh6.googleusercontent.com",
