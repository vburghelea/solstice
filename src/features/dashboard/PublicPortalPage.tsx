...
export function PublicPortalPage() {
  ...
  const marketingUrl = brand.marketingUrl;
  const marketingHost = marketingUrl?.replace(/^https?:\/\//, "");
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">
            {brand.portalSubtitle ?? "Member Portal"}
          </p>
        </div>
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {brand.description ??
                "This portal manages membership, reporting, and organization data."}
            </CardDescription>
          </CardHeader>
            ...
            {marketingUrl ? (
              <div className="text-center">
                <p className="mb-3 text-sm text-gray-600">
                  Looking for general information about {brand.name}?
                </p>
                <Button asChild variant="ghost" className="text-primary">
                  <a href={marketingUrl} target="_blank" rel="noopener noreferrer">
                    Visit {marketingHost ?? marketingUrl}
