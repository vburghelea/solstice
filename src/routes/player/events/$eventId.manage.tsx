...
export const Route = createFileRoute("/player/events/$eventId/manage")({
  beforeLoad: async ({ context, location }) => {
    ...
    if (!isAdminClient(user)) {
      throw redirect({ to: "/player/events" });
    }
  },
  ...
  if (!eventResult?.success || !eventResult.data) {
    return (
      <div className="container mx-auto p-6">
        ...
        <LocalizedButtonLink
          to="/player/events"
          translationKey="links.navigation.back_to_events"
          className="mt-4"
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <LocalizedButtonLink
            ...
            translationKey="links.navigation.view_public_page"
            variant="outline"
          >
