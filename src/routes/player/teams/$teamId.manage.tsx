...
export const Route = createFileRoute("/player/teams/$teamId/manage")({
  loader: async ({ params }) => {
...
function ManageTeamPage() {
  ...
  const updateTeamMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate({ to: "/player/teams/$teamId", params: { teamId } });
    },
    onError: (error) => {
  ...
  return (
    <div className="container mx-auto max-w-2xl p-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-foreground">Manage Team Settings</CardTitle>
